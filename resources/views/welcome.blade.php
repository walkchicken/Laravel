...
<html lang="en">
    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg bg-secondary text-uppercase fixed-top" id="mainNav">
            <div class="container">
                <a class="navbar-brand js-scroll-trigger" href="{{URL::to('/home')}}">CLUB MANAGER</a>
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item mx-0 mx-lg-1"><a class="nav-link py-3 px-0 px-lg-3 rounded js-scroll-trigger" href="#portfolio">Introduce</a></li>
        ...
        <section class="page-section bg-primary text-white mb-0" id="about" >
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-4 ml-auto"><p class="lead">With the desire for new students and everyone can learn about the clubs of the university of architecture in Da Nang.</p></div>
                    <div class="col-lg-4 mr-auto"><p class="lead">I, Duong Cong Nhat built this website based on Laravel 8.x and Bootstrapfree to do that. Any questions please go to Contact Me.</p></div>
                </div>
            </div>
        </section>
         <!-- Contact Section-->
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <img class="img-fluid rounded mb-5" src="{{url('public')}}/frontend/img/portfolio/music.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-5">The youth of students in particular as well as all ages in general are associated with music. The music culture of Vietnam is very diverse from genres, colors and melodies. So with the consent of the delegation of Danang University of Architecture, the music club was officially established on October 10, 2018.</p>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="{{url('public')}}/frontend/img/portfolio/futbal.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-5">As "Bac Ho" said, "being healthy means everything". With the enthusiastic dynamism of youth, sports activities are indispensable for the students. So, with the permission of the delegation from Da Nang University of Architecture, the football club was established in September 2018.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                                        Close Window
                                    </button>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="{{url('public')}}/frontend/img/portfolio/sv5.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-5">Recreational activities train us to be active and love life, the main job of students is to learn to achieve many achievements as a stepping stone for the future, with the permission of the Da Nang architecture delegation, a good year student club was formed so that students can share their learning and practice together.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                                        Close Window
                                    </button>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="{{url('public')}}/frontend/img/portfolio/heart.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-5">"Host Blood", hearing the name, you all know. With the consent of the Department of Health and the delegation of Danang Architecture University. The hot blood club works to help the anemic patients as well as the hospital to perform surgeries.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                                        Close Window
                                    </button>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="{{url('public')}}/frontend/img/portfolio/kinang.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-5">Everyone wants to be perfect, here will train you to be more perfect. It is the skill club.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                                        Close Window
                                    </button>
                        ...
                        <div class="container">
                            <div class="row justify-content-center">
                                <div class="col-lg-8">
                                    ...
                                    <!-- Portfolio Modal - Image-->
                                    <img class="img-fluid rounded mb-5" src="{{url('public')}}/frontend/img/portfolio/datec.png" alt="" />
                                    <!-- Portfolio Modal - Text-->
                                    <p class="mb-5">With the age of 4.0, media and events always bring new colors and create strong viral effects. The media club was created to bring passionate young people into the field.</p>
                                    <button class="btn btn-primary" data-dismiss="modal">
                                        <i class="fas fa-times fa-fw"></i>
                                        Close Window
                                    </button>
